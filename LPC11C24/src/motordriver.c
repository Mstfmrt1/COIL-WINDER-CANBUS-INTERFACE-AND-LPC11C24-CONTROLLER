...
void DC_MOTOR_Init(uint8_t MOTOR_Instance)
{
    ...
    //PINMUX PWM FUNC
    Chip_IOCON_PinMux(LPC_IOCON, DC_MOTOR_CfgParam[MOTOR_Instance].DIR1_PIN , IOCON_MODE_INACT|IOCON_STANDARTOUTPUT, FUNC0);
    Chip_GPIO_SetPinDIROutput(LPC_GPIO, DC_MOTOR_CfgParam[MOTOR_Instance].DIR1_PORT,  DC_MOTOR_CfgParam[MOTOR_Instance].DIR1_PIN);

    Chip_IOCON_PinMux(LPC_IOCON, DC_MOTOR_CfgParam[MOTOR_Instance].DIR2_PIN , IOCON_MODE_INACT|IOCON_STANDARTOUTPUT, FUNC0);
